      ...
      <div className='topic-comments'>
        <div className='topic-article-content'>
          <h2 className='topic-comments-title'>
           {this.state.comments !== null && (this.state.comments.length + (this.state.comments.length === 1 ? ' Comment' : ' Comments')) }
            <CommentsOrderBy onSort={this.props.handleSort} />
            {
              ...
              (
                <div className="alert alert-info" role="alert" style={{marginTop: '10px'}}>
                  ...
                  <span>The Public Consultation has ended.</span>
                  <br /><span><Link to='/'>We invite you to learn about other consultations and participate.</Link></span>
                </div>
              )
            }
          </h2>
