    ...
    return (
      <div className='ext-site-home-multiforum'>
        ...
        <div className='lead-paragraph container'>
          ...
          <p>
          Over the last two years, the Open Government Partnership (OGP) Steering Committee and Support Unit have worked on updating the OGP Participation and Co-creation Standards to foster more ambition and better implemented commitments in open government action plans.
          </p>
          <p>
          We are now asking the OGP global community to review and comment on the proposed changes. Contribute to this process! For more information about the consultation for the new Standards and the proposed changes, <a href="https://www.opengovpartnership.org/stories/help-us-finalize-the-ogp-co-creation-and-participation-standards/" target="_blank">click here.</a>
          </p>
          <br />
        </div>
        <div className="steps" id="follow">
          <div className="container">
            ...
            Read this steps to know how to participate and debate in a effective and collaborative way
            </p>
