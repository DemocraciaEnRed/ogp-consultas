  ...
  fetchStats() {
    fetch(`/ext/api/stats/forum/${this.props.forum.name}`, {
      ...
      .catch(err => {
        ...
        this.setState({ 
        isFetching: false,
        error: 'Error: couldnt get statistics'
        })
      })
  }
          ...
          <div className="col-md-8 offset-md-2">
            <div className="row">
              <div className="col-md-4 stat-container">
                <div className="stat-title">Posted<br />comments</div>
                {
              ...
              <div className="col-md-4 stat-container">
                <div className="stat-title">Replyed<br />comments</div>
                {
                  this.state.isFetching ? 
                  <div className="spinning-loader"></div>
              ...
              <div className="col-md-4 stat-container">
                <div className="stat-title">Comments<br />by participants</div>
                {
                  this.state.isFetching ? 
                  <div className="spinning-loader"></div>
            ...
            </div>
            {
              ...
              <div className="alert alert-danger text-center">
                {this.state.error || 'Error: couldnt get statistics'}
              </div>
            }
          </div>
        </div>
